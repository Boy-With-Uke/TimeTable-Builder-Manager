 ...
 * @author boywithuke
 */
public class WindowSubject_Display extends javax.swing.JFrame {

    /**
     * Creates new form WindowSubject_Display
     */
    public WindowSubject_Display() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Subject Name", "Teacher of this subject"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WindowSubject_Display.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WindowSubject_Display().setVisible(true);
            }
        });
    }
    ...
    private Vector<Vector<Object>> getSubjectDataFromDatabase() throws SQLException {
        ...
        try (Connection connection = Connector.getConnection()) {
            ...
            String query = "SELECT nom_matiere, enseignant_matiere FROM matieres";
            ...
            try (PreparedStatement statement = connection.prepareStatement(query);
                ...
                while (resultSet.next()) {
                    ...
                    row.add(resultSet.getString("nom_matiere"));
                    row.add(resultSet.getString("enseignant_matiere"));
                    data.add(row);
                }
            }
        }
