...
public class WindowSign extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Password.setBackground(new java.awt.Color(51, 57, 67));
        Password.setForeground(new java.awt.Color(154, 154, 154));
            ...
            if (!nom_class.isEmpty() && !pass.isEmpty()) {
                try {
                    ...
                    if (!userExists(connection, nom_class)) {
                        ...
                        javax.swing.JOptionPane.showMessageDialog(this, "Erreur : L'utilisateur '" + nom_class + "' existe déjà.");
                    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WindowSign.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WindowSign().setVisible(true);
            }
        });
    }

    private boolean userExists(Connection connection, String nomClass) throws SQLException {
    ...
    private void Sign(Connection connection, String nomClass, String classSize) throws SQLException {
        // Utilisez une requête SQL pour insérer la nouvelle matière avec son enseignant
        String query = "INSERT INTO user (username, password) VALUES (?, ?)";
        try (PreparedStatement statement = connection.prepareStatement(query)) {
            statement.setString(1, nomClass);
            statement.setString(2, classSize);
