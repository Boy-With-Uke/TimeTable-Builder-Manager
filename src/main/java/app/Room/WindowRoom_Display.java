 ...
 * @author boywithuke
 */
public class WindowRoom_Display extends javax.swing.JFrame {

    /**
     * Creates new form WindowSubject_Display
     */
    public WindowRoom_Display() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WindowRoom_Display.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WindowRoom_Display().setVisible(true);
            }
        });
    }
    ...
    private Vector<Vector<Object>> getSubjectDataFromDatabase() throws SQLException {
        ...
        try (Connection connection = Connector.getConnection()) {
            ...
            String query = "SELECT nom_salle, effectif_salle FROM salle";
            ...
            try (PreparedStatement statement = connection.prepareStatement(query);
                ...
                while (resultSet.next()) {
                    ...
                    row.add(resultSet.getString("nom_salle"));
                    row.add(resultSet.getString("effectif_salle"));
                    data.add(row);
                }
            }
        }
