 ...
 * @author boywithuke
 */
public class WindowTeacher_Display extends javax.swing.JFrame {

    /**
     * Creates new form WindowSubject_Display
     */
    public WindowTeacher_Display() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Teacher's Name", "Subject of this Teacher"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WindowTeacher_Display.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WindowTeacher_Display().setVisible(true);
            }
        });
    }
    ...
    private Vector<Vector<Object>> getSubjectDataFromDatabase() throws SQLException {
        ...
        try (Connection connection = Connector.getConnection()) {
            ...
            String query = "SELECT nom_prof, matiere_prof FROM prof";
            ...
            try (PreparedStatement statement = connection.prepareStatement(query);
                ...
                while (resultSet.next()) {
                    ...
                    row.add(resultSet.getString("nom_prof"));
                    row.add(resultSet.getString("matiere_prof"));
                    data.add(row);
                }
            }
        }
